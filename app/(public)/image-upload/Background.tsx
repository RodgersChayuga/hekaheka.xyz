    ...
    return (
        <div className="h-screen bg-comic-pattern animate-comic-fade relative overflow-hidden ">
            ...
            <div className="-z-10">
                ...
                {/* Clouds */}
                {/* Bottom Left Cloud */}
                <div className="absolute bottom-40 -left-20 w-80 h-80 z-10" >
                    <Image
                ...
                {/* Comic Suns */}
                {/* Top Right (Larger) */}
                <div className="absolute -bottom-[20%] left-90 w-120 h-100 z-20">
                    <Image
                ...
                {/* Top Left (Smaller) */}
                <div className="absolute top-0 left-0 w-56 h-56 z-20">
                    <Image
