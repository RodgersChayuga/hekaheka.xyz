  ...
  return (
    <div className="h-screen bg-comic-pattern animate-comic-fade relative overflow-hidden">
      <div className="-z-10">
        ...
        {/* Clouds */}
        {/* Bottom Left Cloud */}
        <div className="absolute -bottom-30 -left-20 w-80 h-80 z-20" >
          <Image
        ...
        {/* Bottom Right Cloud */}
        <div className="absolute bottom-4 -right-10 w-80 h-80">
          <Image
            src="/images/comic_cloud.png"
        ...
        {/* Comic Suns */}
        {/* Top Right (Larger) */}
        <div className="absolute top-0 right-0 w-80 h-80 z-20">
          <Image
        ...
        {/* Top Left (Smaller) */}
        <div className="absolute top-0 left-0 w-40 h-40 z-20">
          <Image
